            ...
            switch (reaction.emoji.name) {
                case '🎮':
                    if (msg.member.roles.has(a.id)) {
                        //message.delete(2000);
                        return msg.channel.send('You are already in this role.').then(m => m.delete({ timeout: 3000 }));
                    }
                    msg.member.roles.add(a).catch(err => {
                        console.log(err);
                        return msg.channel.send(`Error adding you to this role: **${err.message}**.`)
                    });
                    msg.channel.send(`You have been added to the **${a.name}** role!`).then(m => m.delete({ timeout: 3000 }));
                    message.delete(); // <<<-------- ?*
                    break;
                case '📲':
                    ...
                    msg.member.roles.add(b).catch(err => {
                        console.log(err);
                        return msg.channel.send(`Error adding you to this role: **${err.message}**.`)
                    });
                    msg.channel.send(`You have been added to the **${b.name}** role!`).then(m => m.delete({ timeout: 3000 }));
                    message.delete(); // <<<-------- ?*
                    break;
                case '💾':
                    ...
                    msg.member.roles.add(c).catch(err => {
                        console.log(err);
                        return msg.channel.send(`Error adding you to this role: **${err.message}**.`)
                    });
                    msg.channel.send(`You have been added to the **${c.name}** role!`).then(m => m.delete({ timeout: 3000 }));
                    message.delete(); // <<<-------- ?*
                    break;
                case '💠':
                    ...
                    msg.member.roles.add(d).catch(err => {
                        console.log(err);
                        return msg.channel.send(`Error adding you to this role: **${err.message}**.`)
                    });
                    msg.channel.send(`You have been added to the **${d.name}** role!`).then(m => m.delete({ timeout: 3000 }));
                    message.delete(); // <<<-------- ?*
                    break;
                case '🎨':
                    ...
                    msg.member.roles.add(e).catch(err => {
                        console.log(err);
                        return msg.channel.send(`Error adding you to this role: **${err.message}**.`)
                    });
                    msg.channel.send(`You have been added to the **${e.name}** role!`).then(m => m.delete({ timeout: 3000 }));
                    message.delete(); // <<<-------- ?*
                    break;
            }
